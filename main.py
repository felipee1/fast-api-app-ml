...
async def main():
    ...
    original_paths = ['building_1.jpg','mountain_1.jpg',
    'glacier_1.jpg','sea_1.jpg','street_1.jpg','forest_1.jpg']

    full_original_paths = ['static/original/'+ x for x in original_paths]
    display_names = ['building','mountain','glacier','sea','street','forest']
    column_labels =[]
